...
|`TMC_HIDE_POLICY_MODULE_NAME`|`0x8`|When this flag is set, the Policy Module won't return its own name but the localized name of the Windows default policy module.|
